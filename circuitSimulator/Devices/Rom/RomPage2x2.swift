class RomPage2x2: Device {
    ...
    init(name: String, r0: Pin?, r1: Pin?, c0_: Pin?, c1_: Pin?, outputEnable: Pin?, output: Pin?, d00: Bool, d01: Bool, d10: Bool, d11: Bool) {
        ...
        column0 = RomColumn(name: "\(name)-RomCol0", rows: 2, data: [d00, d01], rowPins: [r0, r1], cEnable_: c0_, output_: busInverter.input)
        column1 = RomColumn(name: "\(name)-RomCol1", rows: 2, data: [d10, d11], rowPins: [r0, r1], cEnable_: c1_, output_: busInverter.input)
